...
def giveTemplate(template):
    ...
    elif template == "Exchange Order: Pickup Filed":
        return (text_eopf, html_eopf)

    elif template == "Refund Completed COD" :
        return (text_rcc, html_rcc)

    elif template == "Refund Completed Prepaid":
        return (text_rcp, html_rcp)

    elif template == "Exchange Request: Size 6 Confirmation":
        return (text_ersc, html_ersc)
